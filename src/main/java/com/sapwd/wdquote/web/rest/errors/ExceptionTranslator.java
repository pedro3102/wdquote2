package com.sapwd.wdquote.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sapwd.wdquote.service.EmailAlreadyUsedException ||
            ex instanceof com.sapwd.wdquote.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.sapwd.wdquote.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.sapwd.wdquote");
    }
}
