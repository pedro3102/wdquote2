package com.wdquote.wdquote2.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.wdquote.wdquote2.service.EmailAlreadyUsedException ||
            ex instanceof com.wdquote.wdquote2.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.wdquote.wdquote2.service.InvalidPasswordException
