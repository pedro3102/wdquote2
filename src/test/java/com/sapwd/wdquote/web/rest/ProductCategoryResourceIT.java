...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(DEFAULT_NAME).picture(DEFAULT_PICTURE);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(UPDATED_NAME).picture(UPDATED_PICTURE);
        return productCategory;
    }
    ...
    void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getPicture()).isEqualTo(DEFAULT_PICTURE);
    }
    ...
    void putExistingProductCategory() throws Exception {
        ...
        updatedProductCategory.name(UPDATED_NAME).picture(UPDATED_PICTURE);
        ...
        assertThat(testProductCategory.getPicture()).isEqualTo(UPDATED_PICTURE);
    }
    ...
    void fullUpdateProductCategoryWithPatch() throws Exception {
        ...
        partialUpdatedProductCategory.name(UPDATED_NAME).picture(UPDATED_PICTURE);
